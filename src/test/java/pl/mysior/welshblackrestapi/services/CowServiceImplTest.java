...
public class CowServiceImplTest {
    ...
    @Before
    public void before(){
        c = new Cow("PL123","imie",new GregorianCalendar(2017,10,3),"1324","13245","M","Brazowy",true);
    }
    ...
    public void findAll_shouldReturnAllCows(){
        Cow c1 = new Cow("PL123","imie",new GregorianCalendar(2017,10,3),"1324","13245","M","Brazowy",true);
